...
>
  <div>
  <Header
        title="WareHouse TRANSFER REQUEST"
    ...
    <form onSubmit={handleFormSubmit}>
      ...
      <label htmlFor="salesRoute">From:</label>
      <select
        id="customer"
  ...
  <label htmlFor="plate">To:</label>
            ...
            >
              <option value="">-- Select receipant --</option>
