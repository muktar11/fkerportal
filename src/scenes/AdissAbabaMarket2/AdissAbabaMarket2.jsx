...
const  AdissAbabaMarket2 = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(process.env.REACT_APP_API_URL+`/commerce/all_price/AdissAbabaMarket2/`);
  ...
  return (
    <Box m="20px">
      <Header
        title="AdissAbabaMarket2 Price Set"
...
export default  AdissAbabaMarket2;