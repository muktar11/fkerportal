...
const SMDPaymentApprovePageUPC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(process.env.REACT_APP_API_URL+"/commerce/sales-order/smd-view/UPC");
  ...
  <TableHead>
    ...
    <TableBody>
      ...
      <TableRow>
        ...
        <TableCell>{selectedRow.Totalp}(Qty)</TableCell>     
          <TableCell>{selectedRow.T}</TableCell>
          <TableCell>{selectedRow.Grand_Total_CASH}(Value)</TableCell>
...
export default SMDPaymentApprovePageUPC;
