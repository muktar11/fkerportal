...
const  AdissAbabaMarket = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(process.env.REACT_APP_API_URL+`/commerce/all_price/AdissAbabaMarket/`);
  ...
  return (
    <Box m="20px">
      <Header
        title="AdissAbabaMarket Price Set"
...
export default AdissAbabaMarket;