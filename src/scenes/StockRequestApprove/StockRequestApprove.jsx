...
const  StockRequestApprovePage = () => {
  ...
  return (
    <Box m="20px">
      <Header title="Stock Request Approve" subtitle="List of Orders that require Verification" />
      <ToastContainer />
      <Box
        m=" 0 0 0"
        height="100vh"
...
export default StockRequestApprovePage;
