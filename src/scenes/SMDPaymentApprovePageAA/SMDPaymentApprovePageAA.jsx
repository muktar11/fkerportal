...
const SMDPaymentApprovePageAA = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(process.env.REACT_APP_API_URL+"/commerce/sales-order/smd-view/AA");
...
export default SMDPaymentApprovePageAA;
