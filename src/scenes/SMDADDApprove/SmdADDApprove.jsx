...
const  SMDAADDApprovePage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(process.env.REACT_APP_API_URL+"/commerce/smd-approve/aadd");
  ...
  const handleApprove = async (id) => {
    try {
      const response = await fetch(process.env.REACT_APP_API_URL+`/commerce/smd-approve/AADD/${id}/`, {
        method: "PUT",
        headers: {
      ...
      const data = await response.json();
      console.log("Sales Order Has Sent to Finance:", data);
      toast.success("Sales Order Has Sent to Finance");
      handleUpdateClick()
      handleCloseModal()
  ...
  const handleReject = async (id) => {
    try {
      const response = await fetch(process.env.REACT_APP_API_URL+`/commerce/sdm-approve-addd-reject-view/${id}/`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
export default SMDAADDApprovePage;