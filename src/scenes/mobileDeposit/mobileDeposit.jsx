...
const MobileFinanceLedgerApprove = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(process.env.REACT_APP_API_URL+"/commerce/mobile-ledger-deposit-approve-view");
...
<div style={{ textAlign: 'center', padding: '10px' }}>
    <Header
      title="SupervisorLedger Deposit"
...
export default MobileFinanceLedgerApprove;
