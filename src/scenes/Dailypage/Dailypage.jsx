...
<Box height="15vh">
  <Header  subtitle="Chart of Daily sales by Customer" />
  ...
  <Box height="15vh">
  <Header  subtitle="Chart of Daily sales by SalesPerson" />
  <Box display="flex" alignItems="center">
...
overflow="hidden">
      ...
      <div className="body-title" style={{ textAlign: "center", marginTop:"10px"  }}>
        <h2> Daily AdissAbaba and UPC SalesReport</h2>
      </div>
