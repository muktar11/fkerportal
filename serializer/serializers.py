...
from Account.models import Staff, WebCustomer, WebCustomerProfile
...
from commerce.models import(
     ...
     InventoryReturnForm, SetPrice, AgentSalesPerfomanceMeasure, SupervisorSalesPerfomanceMeasure )
...
class RegisterWebCustomerSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = WebCustomer
        fields = ('email', 'customer_name', 'password', 'password2', 
                  'sales_route', 'ledger', 'tin_number', 'business_license_no',
            'business_registration_no', 'sales_target', 'gps_coordinates', 
            'ledger', 'is_approved', 'is_credit', 'credit_limit', 'phone', 'contact_information')
